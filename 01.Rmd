...
IAPS consists of the following four components

1. Internet Characteristic Data Collection Engine

This component of IAPS is responsible for collecting internet data from various sources (TBD) and categorizing into seperate geo locations.

2. Analytics Engine

The analytics engine aims to provide analysis of network metrics such as throughput, latency, bandwidth, outages per geo-locations.
